...
struct CredentialDetailView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .sheet(isPresented: $isSheetPresented) {
                CredentialInput(credential: credential, buttonType: "Save Account")
    ...
    func deleteData(data: Credential) {
        context.delete(data)
    }
}

#Preview {
    CredentialDetailView(credential: Credential(account: "sample", username: "sample", password: "sample"))
}
